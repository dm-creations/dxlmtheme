...
?>
	    ...
	    #lo-a { width: 80px; }
	    #lo-b { width: 160px; margin: 0 5px; transform: scale(1.05); }
	    #lo-c { width: 53px; margin-top: -4px; }
	    #lo-d { width: 107px; margin-top: -4px; }
	    #lo-e { width: 116px; margin-top: -4px; }
	    .addressy {
		width:40%; 
		margin-right:60%;
	    }
...
/*	    aside {
	...
	@media all and (max-width: 667px) {
	    ...
	    #lo-a { width: 40px; }
	    #lo-b { width: 90px; margin-left: -3px; transform: scale(1); }
	    #lo-c { width: 29px; }
	    #lo-d { width: 50px; }
	    #lo-e { width: 59px; }
	    .site-info {
	...
	<footer id="colophon" class="site-footer">
            <div class="foot-rows">
                <div id="foot-top-row">
			<div id="lo-a"><img src="http://www.lametalworks.co.uk/wp-content/uploads/2018/03/1200px-ConformitÇ_EuropÇenne_logo.svg_-1.png" alt="All our fabricated steel follows the international manufacturing standard EN1090 Execution Class 2 - CE EN1090-EXC2"></div>
			<div id="lo-c"><img src="http://www.lametalworks.co.uk/wp-content/uploads/2018/03/BCSA-logo-3D-col-e1456834083493_bw-1.png" alt="Member of the British Constructional Steelwork Association Ltd."></div>
		    <div id="lo-d"><img src="http://www.lametalworks.co.uk/wp-content/uploads/2018/03/consider-constructors-logo_bw-1.png"></div>
		    <div id="lo-e"><img src="http://www.lametalworks.co.uk/wp-content/uploads/2018/03/SCCS-UKAS-Colour_bw-1.png"></div>
		    <div id="lo-b"><img src="http://www.lametalworks.co.uk/wp-content/uploads/2018/03/constructionline_transitional_grayscale-1-e1520537212821.png"></div>
                </div>
            <div class="site-info">
...
<script src="http://www.dxlm.co.uk/wp-content/themes/dxlmtheme/js/popout.js"></script>
</body>
</html>
